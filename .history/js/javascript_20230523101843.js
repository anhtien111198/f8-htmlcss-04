...
tabs.forEach((tab, index) => {
  ...
  tab.onclick = function () {
    ...
    $('.tab__content-item.tab__content-item--active').classList.remove('tab__content-item--active').style.display = "none";
    this.classList.add('tab__item--active');
    tabContent.classList.add('tab__content-item---active').style.display = "block";
  }
});